 ...
 */
#if IMAGE_BL1
static const mmap_region_t qmobile_mmap[] = {
	MAP_DEVICE,
	MAP_ROM_PARAM,
	MAP_MMC_SRAM,
	{0}
 ...
 */
#define UNNAME_CONFIGURE_MMU_EL(_el)				\
	void qmobile_init_mmu_el##_el(unsigned long total_base,	\
...
UNNAME_CONFIGURE_MMU_EL(1)
UNNAME_CONFIGURE_MMU_EL(3)

unsigned long plat_get_ns_image_entrypoint(void)
{
	return UNNAME_NS_IMAGE_OFFSET;
}
